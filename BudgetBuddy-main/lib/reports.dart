  ...
  Widget build(BuildContext context) {
    return loading ? Center(child: CircularProgressIndicator()) : ListView(
      ...
      children: [
        ...
        SizedBox(height: 24),
        Text('All Transactions', style: TextStyle(fontSize: 18)),
        SizedBox(height: 8),
        ...(() {
          ...
          return allTransactions.map((t) => Card(
            color: t['type'] == 'income' ? Color(0xFF1A4D2E) : Color(0xFF4B006E),
            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
            margin: EdgeInsets.symmetric(vertical: 4),
            child: ListTile(
              leading: Icon(t['type'] == 'income' ? Icons.arrow_downward : Icons.arrow_upward, color: Colors.white),
