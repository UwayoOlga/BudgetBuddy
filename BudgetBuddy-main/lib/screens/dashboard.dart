                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text(NumberFormat.currency(symbol: ' RWF', decimalDigits: 2).format(budget), style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
                        ],
                      ),
                      Column(
                        ...
                        children: [
                          ...
                          Text(NumberFormat.currency(symbol: ' RWF', decimalDigits: 2).format(spent), style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
                        ],
                      ),
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.end,
                        children: [
                          ...
                          Text(NumberFormat.currency(symbol: ' RWF', decimalDigits: 2).format(balance), style: TextStyle(color: balance >= 0 ? Colors.greenAccent : Colors.redAccent, fontSize: 20, fontWeight: FontWeight.bold)),
                        ],
                      ),
                    ],
                  ),
